    ...
    <section id="offer" className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div className="flex flex-col items-start text-left mb-14">
          <h2 className="text-sm uppercase tracking-[0.3em] text-[#9754DE] font-bold mb-4">
            Our Services
          </h2>

          <h3 className="text-3xl lg:text-5xl font-bold text-white max-w-2xl">
            Everything you need for a
            <span className="text-gray-500"> modern digital presence.</span>
          </h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, idx) => (
            <motion.div
              key={idx}
              whileHover={{ y: -10 }}
              className="p-8 rounded-3xl bg-white/[0.03] border border-white/[0.08] backdrop-blur-md hover:border-purple-500/50 transition-all duration-500 group"
            >
